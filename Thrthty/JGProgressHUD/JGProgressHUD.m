...
- (instancetype)initWithStyle:(JGProgressHUDStyle)style {
    ...
    if (self) {
        ...
        self.contentInsets = UIEdgeInsetsMake(22.0f, 35.0f, 15.0f, 35.0f);
        self.marginInsets = UIEdgeInsetsMake(22.0f, 35.0f, 15.0f, 35.0f);
...
//        else {
            ...
            if (self.style == JGProgressHUDStyleDark) {
                ...
                _HUDView.backgroundColor = [UIColor colorWithRed:240 green:239 blue:239 alpha:.95];
            }
            else {
